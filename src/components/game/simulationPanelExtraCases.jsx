...
export const EXTRA_TESTS = [
  ...
  sourceHas('admin_visibility', 'settings_admin_tools_gated',
    ...
    'pages/AdminPage.jsx',
    adminPageSource,
    ['Admin Ekranı', 'const isAdmin = parsedAdminStatus', 'if (!isAdmin)', 'SimulationPanel', 'Kronox Health Simulator', 'QuestionAnalyticsReportTool', 'ResetUserProgressTool', 'DailyQuestDefinitionManager']),
  ...
  sourceLacks('admin_visibility', 'settings_no_longer_hosts_admin_tools',
    ...
    settingsPageSource,
    ['SimulationPanel', 'Kronox Health Simulator', 'QuestionAnalyticsReportTool', 'ResetUserProgressTool', 'DailyQuestDefinitionManager']),
