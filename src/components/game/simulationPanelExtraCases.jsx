...
export const EXTRA_TESTS = [
  ...
  sourceHas('game_invite_push_notifications', 'push_chain_diagnostics_distinguish_permission_from_subscription',
    ...
    'NotificationSettingsCard.jsx + lib/notificationApi.js',
    `${notificationSettingsCardSource}\n${notificationApiSource}`,
    ['getPushChainDiagnostics', 'hasActiveSubscription', 'no_browser_subscription', 'no_saved_subscription', 'saved_subscription_endpoint_mismatch', 'vapidPublicKeyConfigured'],
    { actionType: ACTION_TYPES.DEVICE_TEST, recentlyFixed: true, runtimeProofRequired: true }),
