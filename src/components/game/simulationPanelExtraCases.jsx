...
export const EXTRA_TESTS = [
  ...
  sourceHas('admin_visibility', 'settings_admin_tools_gated',
    'Remaining Settings admin tools are gated',
    'pages/SettingsPage.jsx',
    settingsPageSource,
    ['isAdmin', 'SimulationPanel', 'Kronox Health Simulator']),
  sourceHas('admin_visibility', 'profile_settings_path_exposes_admin_only_under_isAdmin',
    'Profile → Settings exposes remaining admin tooling only when isAdmin is true',
    'pages/SettingsPage.jsx',
    settingsPageSource,
    ['{isAdmin && (', 'Araçlar']),
