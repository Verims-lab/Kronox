...
export const EXTRA_TESTS = [
  ...
  sourceHas('game_invite_push_notifications', 'permission_states_and_unsupported_paths_handled',
    'Granted/denied/default/unsupported/no-subscription notification states are handled',
    'NotificationSettingsCard.jsx + lib/notificationApi.js',
    `${notificationSettingsCardSource}\n${notificationApiSource}`,
  ...
  sourceHas('game_invite_push_notifications', 'profile_ayarlar_is_single_notification_settings_entry',
    'Profile -> Ayarlar is the single user-facing notification permission/status entry point',
    'ProfilePage.jsx + SettingsPage.jsx',
    `${profilePageSource}\n${settingsPageSource}`,
  ...
  sourceHas('game_invite_push_notifications', 'admin_notification_diagnostics_are_gated',
    ...
    `${settingsPageSource}\n${notificationSettingsCardSource}`,
    ['isAdmin={isAdmin}', 'isAdmin && diagnostics', 'Admin tanılama', 'Aktif kayıt'],
    { actionType: ACTION_TYPES.CODE_FIX, recentlyFixed: true }),
  ...
  sourceHas('game_invite_push_notifications', 'granted_permission_can_renew_missing_subscription',
    'Granted notification permission does not hide a missing/stale subscription; Settings can renew it',
    'NotificationSettingsCard.jsx',
    notificationSettingsCardSource,
    ['Aboneliği Yenile', 'diagnostics.hasActiveSubscription', 'Aktif kayıt', 'Abonelik:'],
    { actionType: ACTION_TYPES.CODE_FIX, recentlyFixed: true }),
  ...
  sourceHas('game_invite_push_notifications', 'subscription_dedupes_by_user_and_endpoint',
    ...
    { actionType: ACTION_TYPES.CODE_FIX, recentlyFixed: true }),
  sourceHas('game_invite_push_notifications', 'settings_subscription_shape_matches_push_backend',
    'Settings-created PushSubscription shape matches what sendGameInvitePush reads',
