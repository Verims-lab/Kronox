  ...
  makeCase('current_contract_freshness_profile_category_questions',
    ...
    () => {
      ...
      const missing = missingTokens(combined, [
        ...
        'Profile > Profil Bilgileri exposes username plus optional private age_group and gender',
        'Profile has local Joker loading, safe error, and retry states.',
        'private identifiers/storage metadata stay forbidden',
        'single canonical live field',
        'Online has no category selection UI',
        'Online questions are drawn randomly from all active categories',
        'Admin-only, read-only content readiness snapshot',
        'full question bank',
        'persist a bounded shared online_question_deck',
        'bounded server attempt candidate buffer',
        'B3 never writes, rewrites, activates, deactivates, rebalances, or deletes Question rows',
        'VAPID private key remains a real server-only secret',
        'VAPID_PUBLIC_KEY is public-by-design',
        'VAPID_SUBJECT is contact/config metadata',
        ...
        'Online winner scoring is exactly +15 Kronox Puan',
        'loser scoring is exactly -6 Kronox Puan',
        'Kronox Seri Sistemi V1 is Solo-only',
        'Joker/Hint-assisted correct cards are neutral',
        'levels 1-6 are visual-only',
        'Daily Goals',
  ...
  makeCase('daily_quest_definition_health_registered',
    ...
    () => {
      ...
      const missing = missingTokens(combined, [
        ...
        'daily_wheel_claim',
        'daily_wheel_claim_completes_task_and_refreshes_status',
        'daily_task_event_source_matrix_and_training_exclusions',
  ...
  makeCase('public_asset_readmes_match_current_contract',
    ...
    async () => {
      ...
      const uiMissing = missingTokens(uiReadme, [
        ...
        'mobile-first',
        'real level-type first Solo level',
