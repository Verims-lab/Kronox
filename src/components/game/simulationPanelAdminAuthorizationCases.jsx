...
function makeCase(suiteId, suiteName, id, description, run, opts = {}) {
  return {
    ...
    title: description,
    description,
    severity: opts.critical === false ? 'INFO' : 'CRITICAL',
    proofQuality: opts.proofQuality || 'SOURCE_CONNECTED',
    fixOwner: opts.fixOwner || 'Backend / runtime',
    nextAction: opts.nextAction || 'Fix the active AdminUser authorization source and rerun this suite.',
    relatedFiles: opts.relatedFiles || ['src/components/game/simulationPanelAdminAuthorizationCases.jsx'],
    runnable: true,
    run,
