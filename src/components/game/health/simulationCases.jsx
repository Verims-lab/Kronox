...
export const TESTS = [
  ...
  sourceHas('offline_solo', 'gameplay_question_fetch_requires_authenticated_projection', 'Solo question loading uses authenticated getQuestions projection', 'useOfflineQuestions.js', SRC.UseOfflineQuestions, ['gameplay_question_fetch_requires_authenticated_getQuestions', 'Gameplay question fetches require the authenticated Base44 session', "base44.functions.invoke('getQuestions'"]),
