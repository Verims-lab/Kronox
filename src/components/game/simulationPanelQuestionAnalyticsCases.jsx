  ...
  makeCase('admin_only_settings_trigger_exists',
    ...
    () => {
      ...
      const missing = missingTokens(combined, [
        ...
        'RESET_REPORT_SCOPE_ITEMS',
        'PROTECTED_RESET_EXCLUSIONS',
        'Bu işlem yalnızca soru analitiği raporlarını sıfırlar',
        'Function reset yolu devre dışıdır',
        'reset şu anda manuel DB bakımıdır',
        'Manuel reset kapsamı: QuestionAttemptEvent, PlayerQuestionDailyExposure, QuestionStatsProjection ve CategoryStatsProjection',
        'PlayerQuestionExposure sadece aynı oyuncuya aynı soruyu tekrar göstermeme hafızası da sıfırlanacaksa ayrıca temizlenir',
        'Sıfırlanacak raporlar ve kaynak tablolar',
        'Kategori Bazında Gösterim',
        ...
        'Kaynak tablolar:',
        'Reset etkisi:',
        'Silinmeyen / etkilenmeyen veriler:',
        'Leaderboard / skor / ekonomi kayıtları',
        'Oyun ilerlemesi, ekonomi kayıtları, kullanıcı profilleri ve soru havuzu silinmez',
        'Son 7 gün',
        'Rapor hazırlanıyor...',
        'result?.recipientEmail',
        'result?.emailDispatchStatus',
