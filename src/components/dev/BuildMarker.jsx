...
// Codex612 — Daily streak reward UX: apply the backend balance patch immediately, show explicit Diamond success feedback, and release the claim loading state before nonblocking status reconciliation; reward authority and amount remain unchanged.
