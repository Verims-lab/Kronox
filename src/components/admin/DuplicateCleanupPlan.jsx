  ...
  return (
    <section className="space-y-2" data-admin-duplicate-cleanup-plan="dry-run-read-only">
      <div className="rounded-xl border border-sky-300/20 bg-sky-400/5 p-3">
        <h3 className="text-xs font-extrabold text-sky-200">Veri Temizliği İncelemesi</h3>
        <p className="mt-1 text-[10px] font-bold text-sky-100">Dry-run · İnceleme-only</p>
        <p className="mt-1 text-[10px] text-muted-foreground">Bu ekran veri silmez, birleştirmez veya güncellemez. Örnekler yalnızca geri döndürülemez fingerprint içerir.</p>
        <p className="mt-2 text-[11px] font-bold text-amber-100">Yürütme engelli</p>
        <p className="mt-1 text-[11px] font-semibold text-amber-100/80">Temizlik ayrı onaylı görev gerektirir.</p>
      </div>
