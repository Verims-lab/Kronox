...
- The deploy gate caps Base44 at 50 function entry files. B1 keeps the repo at that ceiling by reusing adminDuplicateKeyReport. Backend Deno imports/gate still expect @base44/sdk 0.8.34 while the current frontend package sync declares ^0.8.42; this is a pre-deploy compatibility blocker, not a B1 behavior change.
