...
- Sistemdeki Soru Havuzu: Kategori / Zorluk Dağılımı is an email-safe inline HTML/CSS stacked-bar table sourced from active Question rows, includes asked and never-asked questions, avoids JavaScript chart libraries, and appears directly after Key Insights / Risk Flags before long event detail tables.
