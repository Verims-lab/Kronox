...
- Sistemdeki Soru Havuzu: Kategori / Zorluk Dağılımı is an email-safe inline HTML/CSS stacked-bar table sourced from active Question rows, includes asked and never-asked questions, and avoids JavaScript chart libraries.
