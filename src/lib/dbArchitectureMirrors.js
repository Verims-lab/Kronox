...
- sendQuestionAnalyticsReportEmail actual sent body includes Rapor Bölümleri, Kategori Bazında Soru Havuzu, Kategori ve Zorluk Bazında Kayıtlı Soru Sayısı, Kategori Bazında Kayıtlı Soru Havuzu, Kategori Bazında Yıl Aralığı, Kategori Tercihleri, Kategori Bazında Gösterim, Kategori İçi Soru Analizi, Kategori Denge Sinyalleri, and Rapor Tamamlandı. Category preference counts are aggregate distinct-user counts only; no user IDs or emails are exposed.
