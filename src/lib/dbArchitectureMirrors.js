...
- Mağaza Store displays real-money Diamond packages, Diamond-spend Joker packages, Diamond-spend Hint packages, Diamond-spend Advantage packages, and future KronoClub / Reklamları Kaldır sections. Real-money/TL packages stay visible but disabled with exact Yakında copy and real_money_unavailable reason; KronoClub and Reklamları Kaldır stay visible but disabled with exact Yakında copy and future_feature reason. None grant without approved IAP/payment verification. Store purchases do not grant Kronox Puan and do not affect Leaderboard; Online joker usage remains absent.
