...
- Paket B4 is frontend/docs/Health-only. The guarded Yayın Hazırlığı tracker stores no state and adds no entity, function, index, schema, scheduler, cleanup, secret read, or deploy action. Function count remains 50; package-lock, platform indexes, production secrets, RLS/multi-account, live deploy, devices, and stores remain manual/external.
