...
- Live report deploy proof reads reportBuildMarker Codex323, templateVersion nine-section-email-v1, emailBodyMode nine_section_email_body, reportDeliveryMode email_body_only, bodyContainsExactlyRequiredSections true, requiredSectionOrderValid true, renderedSectionHeaderCount 9, and bodyLength > 1000; npm run build only proves the frontend Vite build, not live Base44 function deployment or SendEmail receipt.
...
- manual_db_reset_only clears QuestionAttemptEvent and any populated QuestionStatsProjection/CategoryStatsProjection manual aggregate rows by DB maintenance.
