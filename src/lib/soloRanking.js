...
//   levelScore, stars, timeSeconds, mistakes })` after a passing attempt and renders either the
...
//        { user_email, level_number, level_score, stars, time_seconds,
//          mistakes, created_at }.
//        Then a backend function rankSoloLevel({ levelNumber, levelScore,
//          stars, timeSeconds, mistakes })
...
/**
 * @param {{ levelNumber: number, levelScore: number, stars: number, timeSeconds: number, mistakes: number }} params
...
export async function fetchSoloLevelRank({ levelNumber, levelScore, stars, timeSeconds, mistakes }) {
