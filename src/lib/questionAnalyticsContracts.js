...
export const QUESTION_ANALYTICS_MANUAL_RESET_TABLES = Object.freeze([
...
export const QUESTION_ANALYTICS_OPTIONAL_PLAYER_MEMORY_RESET_TABLE = 'PlayerQuestionExposure';

export const QUESTION_ANALYTICS_MANUAL_RESET_EXCLUDED_TABLES = Object.freeze([
  'Question',
  'Category',
  'User',
  'GuestProfile',
...
export const QUESTION_ANALYTICS_SECURITY_CONTRACT = Object.freeze({
  ...
  dailyExposureResetHandling: 'PlayerQuestionDailyExposure_is_part_of_question_analytics_manual_reset',
  reportProjectionUsage: 'nine_section_report_does_not_require_projection_tables',
  adminResetHandling: 'manual_db_clear_QuestionAttemptEvent_PlayerQuestionDailyExposure_and_if_populated_QuestionStatsProjection_CategoryStatsProjection',
  optionalPlayerMemoryResetHandling: 'PlayerQuestionExposure_optional_reset_clears_per_player_anti_repeat_memory',
