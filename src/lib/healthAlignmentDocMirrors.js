...
- Online question selection, getQuestions, and analytics do not read preferences for question selection. Online start uses startLobbyGame to persist a bounded shared online_question_deck on Lobby from active lobby-selected Category.category_id values only; difficulty 1/2 only; missing/invalid selected categories or Category read failures must not fall back to legacy category names, Lobby.category, or old seeded arrays; Game reads that persisted deck instead of the Solo getQuestions buffer.
