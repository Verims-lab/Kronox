...
- HTTP 401/403 remains critical BACKEND_PERMISSION_DENIED. Correlation exports only scenario, service category, status class, sanitized endpoint category, safe action label, and redacted fingerprint; no blanket optional downgrade, raw URL, credential, or actor identity is allowed. APP_NOT_FOUND forces backendAvailable/base44AppReachable false and cannot preserve backend PASS. Frontend package, lock root/resolution, and critical function imports stay exact 0.8.34.
...
- Permission/RLS denial stays critical and exports only safe scenario/service/status/endpoint/action/fingerprint evidence. APP_NOT_FOUND forces backend availability/reachability false and cannot produce a backend-dependent PASS. Keep @base44/sdk exactly 0.8.34 in package, lockfile, and critical function imports.
