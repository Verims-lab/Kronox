...
30% lane uses all active categories with difficulty 1 only. Online question
...
- This is a soft weighting target with fallback, not hard filtering. The selected-category 70% lane uses selected user categories with difficulty 1 and 2 eligible; the global 30% lane uses all active categories with difficulty 1 only, with selected-category shortage filled from that all-active fallback lane before clean failure.
