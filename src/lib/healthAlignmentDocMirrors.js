...
- Base44 Deno function imports, the existing deploy gate, frontend package.json, and committed package-lock root/resolved package remain pinned to @base44/sdk 0.8.34 exactly. Source-connected Health validates those committed surfaces, and the fail-fast scripts/checkBase44SdkPin.mjs preinstall guard rejects Base44-generated main-branch package drift before dependency installation. The exact-pin Codex commit must still return to main; live backend deployment remains manual proof.
