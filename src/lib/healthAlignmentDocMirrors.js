...
- Base44 Deno function imports and the existing deploy gate remain pinned to npm:@base44/sdk@0.8.34. The current frontend package-layer sync declares @base44/sdk ^0.8.42, so SDK alignment is an explicit pre-deploy blocker. B1 does not silently rewrite dependency/runtime versions or weaken the gate; package-lock resolution remains external package-layer proof.
