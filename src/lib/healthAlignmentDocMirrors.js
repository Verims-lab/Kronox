...
- Accepted outgoing GameInvite history is not replayed as a user feed: notification bootstrap baselines terminal rows, fresh accepts are accepted-at filtered, explicit Testing Agent/Health markers are suppressed, duplicate accepts collapse into one lobby/batch summary, and the shared toast stack is capped at four. Admin Integrity Snapshot exposes bounded dry-run counts/fingerprints only; no username-based or automatic destructive cleanup is allowed.
