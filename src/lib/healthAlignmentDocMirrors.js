...
- The deploy manifest/compile gate enforces a maximum of 50 Base44 function entries, rejects removed legacy/test/diagnostic callables, and exact-pins the frontend package plus Deno imports to @base44/sdk 0.8.34. The repository currently contains 50 entries after the duplicate getPlayerQuestionExposureStats callable was consolidated into the canonical recordPlayerQuestionExposure read_stats action; the stable frontend gateway and public response shape remain compatible, and the removed name is denylisted against restoration. No active product capability or Admin/safety/cleanup/proof tool was removed. The GitHub package layer commits package-lock.json at exact SDK 0.8.34, while embedded Base44 Health still treats lock resolution as external proof. Current P0 paths include createGuestProfile, getQuestions, findLobbyByCode, startLobbyGame, updateLobbyGameState, getOnlinePlayerSelection, createGameInvitesForTargets, sendFriendRequest, updatePlayerPresence, consumeUserHint, spendUserJoker, getDailyQuestStatus, recordDailyQuestProgress, claimDailyQuestReward, and admin duplicate report/cleanup functions.
...
- Security Pass 1 pins package.json and the GitHub package-lock root/resolution exactly at @base44/sdk 0.8.34 and aligns Base44 Deno function imports to npm:@base44/sdk@0.8.34. Embedded Base44 Health still treats lockfile resolution as external package-layer proof. Do not reintroduce frontend ^ SDK ranges, unversioned function SDK imports, or npm:@base44/sdk@0.8.25 without a documented Base44 runtime compatibility split.
