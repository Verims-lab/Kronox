...
- BottomNav has exactly Ana Sayfa, Liderlik, and Profil; its active state comes from the committed pathname. Root tab taps open /, /leaderboard, and /profile. Lazy route fallback replaces previous content, and rapid taps/back/forward never pair old page content with a new tab highlight. Online remains Home CTA-owned.
