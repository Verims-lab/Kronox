...
- Kronox Seri Sistemi V1 is Solo-only: clean correct placements trigger Kombo x2 / Alev Serisi / streak4 +3 Diamonds / KRONOX SERİSİ streak5 +5 Diamonds; wrong resets; Joker/Hint-assisted correct cards are neutral; levels 1-6 are visual-only; rewards are idempotent per attempt and do not affect Kronox Puan, Leaderboard, Daily Goals, Daily Wheel, or Online.
...
- useSoloStreakSystem applies the pure Solo streak transition only after confirmed placement results. Clean correct answers increment; wrong resets; real Joker/Hint use is neutral; levels 1-6 are visual-only; authenticated streak4/streak5 Diamond claims use the existing economy callable action with lock, receipt verification, and per-attempt idempotency. Online, Puan, Leaderboard, and Daily event paths remain separate.
...
## Solo Streak V1
Kronox Seri Sistemi is Solo-only. Thresholds 2/3/4/5 show Kombo x2, Alev Serisi, +3 Elmas, and KRONOX SERİSİ / +5 Elmas. Wrong resets; Joker/Hint-assisted correct cards are neutral; levels 1-6 are visual-only. Rewards use DiamondTransaction.source solo_streak and are idempotent once per attempt/milestone with no Puan, Leaderboard, Online, or Daily impact. Guest visual feedback is active; guest reward claims remain fail-closed until reward-verifiable guest answer receipts exist. Targeted Solo Streak System Health Suite plus manual 320/360/390px and reduced-motion proof are required.
