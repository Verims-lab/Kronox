...
- Game question loading first attempts online getQuestions when online or network state is unknown; guest/no-auth Solo uses the public-safe minimal projection, empty local cache is not offline, stale cache is invalidated by question-runtime-v4-active-category-full-pool, Retry re-fetches online, and false offline/no-cache is reserved for known offline plus failed fetch plus no usable cache.
