...
- Online offers Arkadaşını Davet Et (invite mode, 60s Pre-game Hourglass wait) and Rastgele Eşleş (random matchmaking queue, 30s Pre-game Hourglass wait). Optional manual invite/social-player-list load failure is local to the invite card only and must never block the Online page or disable Rastgele Eşleş.
