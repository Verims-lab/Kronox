...
export const SOLO_ONBOARDING_MAX_EVALUATED_MOVES = SOLO_NORMAL_MAX_EVALUATED_MOVES;
...
export const SOLO_BEFORE_AFTER_DECK_SIZE = SOLO_BEFORE_AFTER_REFERENCE_CARDS + SOLO_ONBOARDING_MAX_EVALUATED_MOVES + SOLO_JOKER_BUFFER_CARDS;
export const SOLO_TIMELINE_BASIC_DECK_SIZE = SOLO_TIMELINE_BASIC_REFERENCE_CARDS + SOLO_ONBOARDING_MAX_EVALUATED_MOVES + SOLO_JOKER_BUFFER_CARDS;
