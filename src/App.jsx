...
function App() {
  // Codex175 — push build marker into diag bus once at app boot
  useEffect(() => {
    appDiagSetBuildMarker('Codex175');
    // Codex175 — App booted successfully, so any prior stale-chunk reload
