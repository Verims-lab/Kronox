...
function App() {
  // Codex174 — push build marker into diag bus once at app boot
  useEffect(() => {
    appDiagSetBuildMarker('Codex174');
    // Codex174 — App booted successfully, so any prior stale-chunk reload
