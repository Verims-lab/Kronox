...
function App() {
  // Codex173 — push build marker into diag bus once at app boot
  useEffect(() => {
    appDiagSetBuildMarker('Codex173');
    // Codex173 — App booted successfully, so any prior stale-chunk reload
