...
Phase 2 replaces the old tutorial with a real level-type first Solo level but does not
change Solo scoring, Online scoring, Kronox Puan calculation, drag/drop, or
leaderboard ranking rules.

The first level is intentionally forgiving and instructional. It may
